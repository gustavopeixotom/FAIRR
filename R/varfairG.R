#' Estimate FAIR_G(K) Models from Shocks Orthogonalized with a VAR
#'
#' @description
...
#' @param X A numeric vector or matrix. The controls for the VAR.
...
#' @export
#' @import rstan
#' @importFrom stats lm loess predict quantile residuals sd
#' @importFrom vars VAR VARselect irf
#' @importFrom pracma findpeaks
#' @importFrom parallel detectCores
#' @importFrom R.utils withTimeout
#' @importMethodsFrom rstan extract
varfairG <- function(Y, Z, X = NULL, H, K = 1, asym = FALSE, maxvarlag = 12, varci = FALSE, varboot = 500, spanloess = 0.5, sdpar = 10, cores = NA, chains = 4, iter = 2000, adapt_delta = 0.95, max_treedepth = 12, timeout = 180) {
  start_time <- Sys.time()
