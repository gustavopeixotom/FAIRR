...
exofair <- function(Y, Z, H, K = 1, priorvec = c(1, 1, 1), detrend = 0, asym = FALSE, sdpar = 20, cores = NA, chains = 4, iter = 2000, adapt_delta = 0.95, max_treedepth = 12, timeout = 180) {
  start_time <- Sys.time() 
  ...
  if (detrend > 2) {
    stop("trend cannot be more than 2")
  } 
